...
class Ac19Modelinscriptions extends JModelList
{
	...
	protected function _getListQuery()
	{
		...
		$query->select('i.id, i.nom, i.prenom, i.civilites_id, i.typescontacts_id, i.entreprises_id, i.fonction, i.email, i.mobile, i.tel, i.published, i.hits, i.modified');
		$query->from('#__ac19_inscriptions i');
		...
		if (!empty($search)) {
			...
			if (stripos($search, 'id:') === 0) {
				...
				$searches	= array();
				$searches[]	= 'i.nom LIKE '.$search;
				$searches[]	= 'i.prenom LIKE '.$search;
				$searches[]	= 'i.email LIKE '.$search;
