...
$uriCompoDetail = JURI::base(true)."/index.php?option=com_ac19&view=message&id=";
...
<form action="<?php echo JUri::getInstance()->toString(); ?>" method="post" name="adminForm" id="adminForm">
	...
	<table class="table table-striped" id="articleList">
		<thead>
			<tr>
				<th class="title">
					<?php echo JHtml::_('grid.sort', JText::_('COM_AC19_MESSAGES_DATE'), 'date', $listDirn, $listOrder) ?>
				</th>
				<th class="title">
