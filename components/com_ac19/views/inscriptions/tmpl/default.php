...
<?php else : ?>
	...
	<h2><?php echo JText::_('COM_AC19_OPTIONS')." : ".JText::_('COM_AC19_CONTACTS')." - "; ?>
		<a href="<?php echo JRoute::_('index.php?option=ac_19&view=inscriptions'); ?>">
			<?php echo JText::_('COM_AC19_INSCRIPTIONS'); ?>
		</a>
	</h2>
