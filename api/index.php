<?php
/**
 * @copyright  Copyright (C) 2016-2020 Open Source Matters, Inc. All rights reserved.
...
require_once JPATH_BASE . '/application/ac19.php';
$app = JApplicationWeb::getInstance('AppAc19Web');
