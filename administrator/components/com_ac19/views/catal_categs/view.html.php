...
class Ac19ViewCatal_categs extends JViewLegacy
{
	function display($tpl = null) 
	{
		...
		utilisateurHelper::addSubmenu('catal_categs');
	...
	protected function addToolBar() 
	{
		...
		JToolBarHelper::title(JText::_('COM_AC19_OPTIONS')." : ".JText::_('COM_AC19_CATAL_CATEG'));
		
		// affiche les boutons d'action
		JToolBarHelper::addNew('catal_categ.add');
		JToolBarHelper::editList('catal_categ.edit');
		JToolBarHelper::deleteList('COM_AC19_DELETE_CONFIRM', 'catal_categs.delete');		
		JToolbarHelper::publish('catal_categs.publish', 'JTOOLBAR_PUBLISH', true);
		JToolbarHelper::unpublish('catal_categs.unpublish', 'JTOOLBAR_UNPUBLISH', true);
		JToolbarHelper::archiveList('catal_categs.archive');
		JToolbarHelper::checkin('catal_categs.checkin');
		JToolbarHelper::trash('catal_categs.trash');
