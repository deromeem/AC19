...
class Ac19ViewUtilisateur extends JViewLegacy
{
	protected $form;
	protected $item;
	protected $state;
	...
	{			
		...
		JToolBarHelper::title(JText::_('COM_AC19_UTILISATEUR')." : ".($isNew ? JText::_('COM_AC19_NEW'): JText::_('COM_AC19_MODIF')), 'address');
