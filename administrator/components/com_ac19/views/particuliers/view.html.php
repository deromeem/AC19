...
class Ac19ViewParticuliers extends JViewLegacy
{
	function display($tpl = null) 
	{
		...
		utilisateurHelper::addSubmenu('particuliers');
	...
	protected function addToolBar() 
	{
		...
		JToolBarHelper::title(JText::_('COM_AC19_OPTIONS')." : ".JText::_('COM_AC19_particulierS'));
		
		// affiche les boutons d'action
		JToolBarHelper::addNew('particulier.add');
		JToolBarHelper::editList('particulier.edit');
		JToolBarHelper::deleteList('COM_AC19_DELETE_CONFIRM', 'particuliers.delete');		
		JToolbarHelper::publish('particuliers.publish', 'JTOOLBAR_PUBLISH', true);
		JToolbarHelper::unpublish('particuliers.unpublish', 'JTOOLBAR_UNPUBLISH', true);
		JToolbarHelper::archiveList('particuliers.archive');
		JToolbarHelper::checkin('particuliers.checkin');
		JToolbarHelper::trash('particuliers.trash');
