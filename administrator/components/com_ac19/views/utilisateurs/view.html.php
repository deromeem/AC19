...
class Ac19ViewUtilisateurs extends JViewLegacy
{
	...
	protected function addToolBar() 
	{
		...
		JToolBarHelper::deleteList('COM_AC19_DELETE_CONFIRM', 'utilisateurs.delete');		
 	...
 	protected function getSortFields()
	{
		...
		return array(
			'u.nom' => JText::_('COM_AC19_UTILISATEURS_NOM'),
			'u.prenom' => JText::_('COM_AC19_UTILISATEURS_PRENOM'),
			'u.email' => JText::_('COM_AC19_UTILISATEURS_EMAIl'),
			'u.tel' => JText::_('COM_AC19_UTILISATEURS_TEL'),
			'u.id' => "Id"
		);
	}  
