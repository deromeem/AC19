...
?>
	...
	<tr>
        ...
        <th width="30%">
			<?php echo JHtml::_('grid.sort', 'COM_AC19_UTILISATEURS_NOM', 'u.nom', $listDirn, $listOrder) ?>
        </th>
        <th width="30%" class="nowrap">
			<?php echo JHtml::_('grid.sort', 'COM_AC19_UTILISATEURS_PRENOM', 'u.prenom', $listDirn, $listOrder) ?>
        </th>
        <th width="20%" class="nowrap">
			<?php echo JHtml::_('grid.sort', 'COM_AC19_UTILISATEURS_EMAIL', 'u.email', $listDirn, $listOrder) ?>
        </th>
        <th width="20%" class="nowrap">
			<?php echo JHtml::_('grid.sort', 'COM_AC19_UTILISATEURS_TEL', 'u.tel', $listDirn, $listOrder) ?>
        </th>
