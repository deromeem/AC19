...
<script type="text/javascript">
	...
	{
		if (task == 'stock.cancel' || document.formvalidator.isValid(document.id('ac19-form')))
		{
...
<form action="<?php echo JRoute::_('index.php?option=com_ac19&layout=edit&id='.(int) $this->item->id); ?>"
	...
	<div class="form-inline form-inline-header">
		<div class="control-group">
			<div class="control-label"><?php echo $this->form->getLabel('qte'); ?></div>
			<div class="controls"><?php echo $this->form->getInput('qte'); ?></div>
		</div>										
	</div>					
