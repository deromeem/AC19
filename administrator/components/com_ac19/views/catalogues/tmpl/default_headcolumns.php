...
?>
	...
	<tr>
        ...
        <th width="30%">
			<?php echo JHtml::_('grid.sort', 'COM_AC19_CATALOGUES_TITRE', 'c.titre', $listDirn, $listOrder) ?>
        </th>
        <th width="30%" class="nowrap">
			<?php echo JHtml::_('grid.sort', 'COM_AC19_CATALOGUES_DESCRIPTION', 'c.description', $listDirn, $listOrder) ?>
        </th>
        <th width="20%" class="nowrap">
			<?php echo JHtml::_('grid.sort', 'COM_AC19_CATALOGUES_DATE_DEBUT', 'c.dateDebut', $listDirn, $listOrder) ?>
        </th>
        <th width="20%" class="nowrap">
			<?php echo JHtml::_('grid.sort', 'COM_AC19_CATALOGUES_DATE_FIN', 'c.dateFin', $listDirn, $listOrder) ?>
		<th width="20%" class="nowrap">
			<?php echo JHtml::_('grid.sort', 'COM_AC19_CATALOGUES_PARTENAIRE', 'c.partenaires_id', $listDirn, $listOrder) ?>
        </th>
