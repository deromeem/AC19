...
<script type="text/javascript">
	...
	{
		if (task == 'type_mag.cancel' || document.formvalidator.isValid(document.id('ac19-form')))
		{
		...
		<div class="row-fluid ">
			<div class="span9">
				<div class="form-vertical">
					<div class="control-group">
						<div class="span2">
							<div class="control-label"><?php echo $this->form->getLabel('typeMag'); ?></div>
						</div>					
						<div class="span7">
							<div class="controls"><?php echo $this->form->getInput('typeMag'); ?></div>
						</div>					
					</div>				
				</div>
			</div>
