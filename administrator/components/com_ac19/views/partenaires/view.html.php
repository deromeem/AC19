...
class Ac19ViewPartenaires extends JViewLegacy
{
	function display($tpl = null) 
	{
		...
		utilisateurHelper::addSubmenu('partenaires');
	...
	protected function addToolBar() 
	{
		...
		JToolBarHelper::title(JText::_('COM_AC19_OPTIONS')." : ".JText::_('COM_AC19_PARTENAIRES'));
		
		// affiche les boutons d'action
		JToolBarHelper::addNew('partenaires.add');
		JToolBarHelper::editList('partenaires.edit');
		JToolBarHelper::deleteList('COM_AC19_DELETE_CONFIRM', 'partenaires.delete');		
		JToolbarHelper::publish('partenaires.publish', 'JTOOLBAR_PUBLISH', true);
		JToolbarHelper::unpublish('partenaires.unpublish', 'JTOOLBAR_UNPUBLISH', true);
		JToolbarHelper::archiveList('partenaires.archive');
		JToolbarHelper::checkin('partenaires.checkin');
		JToolbarHelper::trash('partenaires.trash');
 	...
 	protected function getSortFields()
	{
		...
		return array(
			'p.email' => JText::_('COM_AC19_PARTENAIRES_EMAIL'),
			'p.raisonSociale' => JText::_('COM_AC19_PARTENAIRES_RAISON_SOCIALE'),
			'p.numSiren' => JText::_('COM_AC19_PARTENAIRES_NUM_SIREN'),
		);
	}  
