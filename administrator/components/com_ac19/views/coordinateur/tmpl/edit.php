...
<script type="text/javascript">
	...
	{
		if (task == 'coordinateur.cancel' || document.formvalidator.isValid(document.id('ac19-form')))
		{
...
<form action="<?php echo JRoute::_('index.php?option=com_ac19&view=coordinateur&layout=edit&id='.(int) $this->item->id); ?>"
