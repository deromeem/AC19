...
class Ac19ViewLigne_cdes extends JViewLegacy
{
	function display($tpl = null) 
	{
		...
		utilisateurHelper::addSubmenu('ligne_cdes');
	...
	protected function addToolBar() 
	{
		...
		JToolBarHelper::title(JText::_('COM_AC19_OPTIONS')." : ".JText::_('COM_AC19_LIGNE_CDES'));
		
		// affiche les boutons d'action
		JToolBarHelper::addNew('ligne_cde.add');
		JToolBarHelper::editList('ligne_cde.edit');
		JToolBarHelper::deleteList('COM_AC19_DELETE_CONFIRM', 'ligne_cdes.delete');		
		JToolbarHelper::publish('ligne_cdes.publish', 'JTOOLBAR_PUBLISH', true);
		JToolbarHelper::unpublish('ligne_cdes.unpublish', 'JTOOLBAR_UNPUBLISH', true);
		JToolbarHelper::archiveList('ligne_cdes.archive');
		JToolbarHelper::checkin('ligne_cdes.checkin');
		JToolbarHelper::trash('ligne_cdes.trash');
 	...
 	protected function getSortFields()
	{
		...
		return array(
			'l.qteCde' => JText::_('COM_AC19_LIGNE_CDES_QTE_CDE'),
			'l.qteLivr' => JText::_('COM_AC19_LIGNE_CDES_QTE_LIVR'),
			'l.commandes_id' => JText::_('COM_AC19_LIGNE_CDES_COMMANDES'),
			'l.produits_id' => JText::_('COM_AC19_LIGNE_CDES_PRODUITS'),
			'l.id' => "Id"
		);
	}  
