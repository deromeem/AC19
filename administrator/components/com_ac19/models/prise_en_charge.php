...
class Ac19ModelPrise_en_charge extends JModelAdmin
{
	protected $_compo = 'com_ac19';
	protected $_context = 'prise_en_charge';
	public $typeAlias = 'com_ac19.prise_en_charge';
	
	// Surcharges des méthodes de la classe mère pour :
	
	// 1) définir la table de soutien à utiliser
	public function getTable($type = 'Prise_en_charge', $prefix = 'Ac19Table', $config = array()) 
	{
	...
	protected function prepareTable($table)
	{
		...
		{
			$table->alias = JApplication::stringURLSafe($table->dateHeureDebut);
		}
	}
}
