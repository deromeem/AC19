...
class Ac19ModelType_mags extends JModelList
{
	...
	protected function populateState($ordering = null, $direction = null)
	{
		...
		parent::populateState('tm.typeMag', 'ASC');
	}
	...
	protected function getListQuery()
	{
		...
		$query->select('tm.id, tm.typeMag, tm.published, tm.hits, tm.modified');
		$query->from('#__ac19_type_mags tm');
		...
		if (!empty($search)) {
			...
			if (stripos($search, 'id:') === 0) {
				...
				$searches	= array();
				$searches[]	= 'tm.typeMag LIKE '.$search;
		...
		// tri des colonnes
		$orderCol = $this->state->get('list.ordering', 'tm.typeMag');
