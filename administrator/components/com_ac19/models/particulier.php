...
class Ac19ModelParticulier extends JModelAdmin
{
	protected $_compo = 'com_ac19';
	protected $_context = 'particulier';
	public $typeAlias = 'com_ac19.particulier';
	
	// Surcharges des méthodes de la classe mère pour :
	
	// 1) définir la table de soutien à utiliser
	public function getTable($type = 'Particulier', $prefix = 'Ac19Table', $config = array()) 
	{
