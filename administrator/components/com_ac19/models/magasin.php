...
class Ac19ModelMagasin extends JModelAdmin
{
	protected $_compo = 'com_ac19';
	protected $_context = 'magasin';
	public $typeAlias = 'com_ac19.magasin';
	
	// Surcharges des méthodes de la classe mère pour :
	
	// 1) définir la table de soutien à utiliser
	public function getTable($type = 'Magasin', $prefix = 'Ac19Table', $config = array()) 
	{
