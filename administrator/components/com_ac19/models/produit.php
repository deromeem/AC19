...
class Ac19ModelProduit extends JModelAdmin
{
	protected $_compo = 'com_ac19';
	protected $_context = 'produit';
	public $typeAlias = 'com_ac19.produit';
	
	// Surcharges des méthodes de la classe mère pour :
	
	// 1) définir la table de soutien à utiliser
	public function getTable($type = 'Produit', $prefix = 'Ac19Table', $config = array()) 
	{
