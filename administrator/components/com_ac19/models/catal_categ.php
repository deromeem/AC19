...
class Ac19ModelCatal_categ extends JModelAdmin
{
	protected $_compo = 'com_ac19';
	protected $_context = 'catal_categ';
	public $typeAlias = 'com_ac19.catal_categ';
	
	// Surcharges des méthodes de la classe mère pour :
	
	// 1) définir la table de soutien à utiliser
	public function getTable($type = 'Catal_categ', $prefix = 'Ac19Table', $config = array()) 
	{
	...
	protected function prepareTable($table)
	{
		...
		{
			$table->alias = JApplication::stringURLSafe($table->titre);
		}
	}
}