...
class Ac19ModelStock extends JModelAdmin
{
	protected $_compo = 'com_ac19';
	protected $_context = 'stock';
	public $typeAlias = 'com_ac19.stock';
	
	// Surcharges des méthodes de la classe mère pour :
	
	// 1) définir la table de soutien à utiliser
	public function getTable($type = 'Stock', $prefix = 'Ac19Table', $config = array()) 
	{
