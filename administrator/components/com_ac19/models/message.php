...
class Ac19ModelMessage extends JModelAdmin
{
	protected $_compo = 'com_ac19';
	protected $_context = 'message';
	public $typeAlias = 'com_ac19.message';
	
	// Surcharges des méthodes de la classe mère pour :
	
	// 1) définir la table de soutien à utiliser
	public function getTable($type = 'Message', $prefix = 'Ac19Table', $config = array()) 
	{
	...
	protected function prepareTable($table)
	{
		...
		{
			$table->alias = JApplication::stringURLSafe($table->date);
		}
	}
}
