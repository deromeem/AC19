...
class Ac19ModelCoordinateur extends JModelAdmin
{
	protected $_compo = 'com_ac19';
	protected $_context = 'coordinateur';
	public $typeAlias = 'com_ac19.coordinateur';
	
	// Surcharges des méthodes de la classe mère pour :
	
	// 1) définir la table de soutien à utiliser
	public function getTable($type = 'Coordinateur', $prefix = 'Ac19Table', $config = array()) 
	{
	...
	protected function prepareTable($table)
	{
		...
		{
			$table->alias = JApplication::stringURLSafe($table->mail);
		}
	}
}
