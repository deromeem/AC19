...
class Ac19ModelCategorie extends JModelAdmin
{
	protected $_compo = 'com_ac19';
	protected $_context = 'categorie';
	public $typeAlias = 'com_ac19.categorie';
	
	// Surcharges des méthodes de la classe mère pour :
	
	// 1) définir la table de soutien à utiliser
	public function getTable($type = 'Categorie', $prefix = 'Ac19Table', $config = array()) 
	{
