...
class Ac19ModelPartenaire extends JModelAdmin
{
	protected $_compo = 'com_ac19';
	protected $_context = 'partenaire';
	public $typeAlias = 'com_ac19.partenaire';
	
	// Surcharges des méthodes de la classe mère pour :
	
	// 1) définir la table de soutien à utiliser
	public function getTable($type = 'Partenaire', $prefix = 'Ac19Table', $config = array()) 
	{
