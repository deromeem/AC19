...
class Ac19ModelBenevole extends JModelAdmin
{
	protected $_compo = 'com_ac19';
	protected $_context = 'benevole';
	public $typeAlias = 'com_ac19.benevole';
	
	// Surcharges des méthodes de la classe mère pour :
	
	// 1) définir la table de soutien à utiliser
	public function getTable($type = 'Benevole', $prefix = 'Ac19Table', $config = array()) 
	{
