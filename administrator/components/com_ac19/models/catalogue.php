...
class Ac19ModelCatalogue extends JModelAdmin
{
	protected $_compo = 'com_ac19';
	protected $_context = 'catalogue';
	public $typeAlias = 'com_ac19.catalogue';
	
	// Surcharges des méthodes de la classe mère pour :
	
	// 1) définir la table de soutien à utiliser
	public function getTable($type = 'Catalogue', $prefix = 'Ac19Table', $config = array()) 
	{
